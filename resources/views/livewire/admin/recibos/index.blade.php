        ...
        <div class="relative w-full max-w-lg rounded-3xl bg-white shadow-2xl border border-gray-200 p-6">
            ...
            <div class="mt-6 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                ...
                <button type="button"
                    ...
                    class="inline-flex items-center justify-center px-4 py-2.5 rounded-2xl bg-red-600 text-white text-sm font-semibold hover:bg-red-700 transition">
                    Sí, cancelar y revertir
                </button>
            </div>
        </div>
    </div>
