    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <a href="{{ route('admin.sistema.configuracion') }}"
                ...
                <div class="mb-4">
                    <svg class="h-8 w-8 text-gray-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Activa o desactiva módulos del sistema según el plan contratado.
                </p>
            </a>
