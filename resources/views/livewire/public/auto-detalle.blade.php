            ...
            <aside class="lg:sticky lg:top-24 space-y-4">
                ...
                <div class="rounded-2xl border border-white/[0.08] bg-slate-900/80 backdrop-blur p-6 shadow-2xl shadow-black/40">
                    ...
                    <a href="https://wa.me/{{ $whatsapp }}?text={{ urlencode($mensajeWa) }}"
                       ...
                       class="mt-5 flex w-full items-center justify-center gap-2.5 rounded-xl bg-emerald-500 px-5 py-4 text-sm font-bold text-white shadow-lg shadow-emerald-900/30 transition hover:bg-emerald-400 active:scale-[0.98]">
    ...
    <section class="relative overflow-hidden border-t border-white/[0.06]" aria-labelledby="cta-detalle-heading">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                <a href="https://wa.me/{{ $whatsapp }}?text={{ urlencode($mensajeWa) }}"
                   target="_blank" rel="noopener noreferrer"
                   class="inline-flex items-center justify-center gap-2.5 rounded-xl bg-emerald-500 px-7 py-4 text-sm font-bold text-white shadow-lg shadow-emerald-900/30 transition hover:bg-emerald-400 active:scale-[0.97]">
