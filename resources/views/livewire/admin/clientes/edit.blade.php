<div class="p-4 sm:p-6 space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-0.5">Actualiza información general y documentos privados.</p>
        </div>
    ...
    <form wire:submit="actualizar" class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="rounded-lg border border-slate-200 p-4 space-y-3">
                        ...
                        @else
                            <p class="text-xs text-slate-400">No hay INE cargado.</p>
                        @endif
                        ...
                        <p class="text-xs text-slate-400">Sube un nuevo archivo para reemplazar el actual.</p>
                    ...
                    <div class="rounded-lg border border-slate-200 p-4 space-y-3">
                        ...
                        @else
                            <p class="text-xs text-slate-400">No hay comprobante cargado.</p>
                        @endif
